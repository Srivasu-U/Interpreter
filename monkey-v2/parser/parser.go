...
func (p *Parser) parseIdentifier() ast.Expression { // The return type can be *ast.IntegerLiteral as well because *Var is a dereference to the interface
	return &ast.Identifier{Token: p.curToken, Value: p.curToken.Literal}
}

func (p *Parser) parseIntegerLiteral() ast.Expression { // The return type can be *ast.IntegerLiteral as well because *Var is a dereference to the interface
